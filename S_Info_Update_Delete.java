...
public class S_Info_Update_Delete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jEnrollNo.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        jComboBoxDept.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CSE", "ME", "CIVIL ENGG.", "ECE", " " }));
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                                            ...
                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                            .addComponent(jEnrollNo, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void jUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jUpdateActionPerformed
     ...
     /* String sql="update Student_Reg_Table set UserName=?,Name=?,Email=?,Password=?,ClassRoll=?,Section=?,Deartment=?,Gender=?,Dtae_of_birth=?,Phone=?,Address=? where ClassRoll="+jClassRoll.getText()+"";
      ...
      if(con !=null){
           ...
           String sql="update Student_Reg_Table set UserName=?,Name=?,Email=?,Password=?,EnrollNo=?,Section=?,Department=?,Gender=?,DateOfBirth=?,Phone=?,Address=? where Phone="+phone+"";
            try {
                pst=con.prepareStatement(sql);
    ...
    private void jAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jAddActionPerformed
        ...
        if(con !=null){
            ...
            String sql = "INSERT INTO Student_Reg_Table (Username,Name,Email,Password,EnrollNo,Section,Department,Gender,DateOfBirth,Phone,Address) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
            try {
                pst=con.prepareStatement(sql);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(rs.next()){
           ...
           String date_o_b=rs.getString("DateOfBirth");
