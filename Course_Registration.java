...
public class Course_Registration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableCourse.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ass_ID", "Teacher_ID", "CourseID", "Couse_Name", "Credit", "Section", "Teacher"
            }
        ));
        ...
        jCourseName.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Basic Computer Engineering", "Engineering Physics", "Civil Engineerng", "Mechanical Engineering", "Engineering Chemistry", " ", " " }));
        ...
        jCourseID.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BT-101", "BT-102", "BT-103", "BT-104", "BT-105", "BT-106", "CS-201", "CS-202", "CS-203", "CS-204", "CS-205", " " }));
