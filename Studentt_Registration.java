...
public class Studentt_Registration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jDepartment.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CSE", "ECE", "EXE", "ME", "CIVIL ENGG.", " " }));
        ...
        jSection.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A", "B", "C", " " }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(con !=null){
        String user_name=jUsername.getText();
        String name=jName.getText();
        String email=jEmail.getText();
        String password=String.valueOf(jPassword.getPassword());
        String enrollno=jID.getText();
        ...
        String date_of_birth=jDateob.getText();
        ...
        String sql = "INSERT INTO Student_Reg_Table (Username,Name,Email,Password,EnrollNo,Section,Department,Gender,DateOfBirth,Phone,Address) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
            try {
                ...
                pst.setString(5,enrollno);
                pst.setString(6, section);
                pst.setString(7, dept);
                pst.setString(8, gender);
                pst.setString(9, date_of_birth);
